...
public record SeatStatusDto(
    ...
    public static SeatStatusDto forSession(SeatEntity seat, TicketStatus ticketStatus,
            BigDecimal sessionBasePrice) {
        ...
        return new SeatStatusDto(
                ...
                seat.getSeatType().getId(),
                seat.getSeatType().getName(),
                ticketStatus == null ? "available" : ticketStatus.name().toLowerCase(),
                sessionBasePrice,
                finalPrice);
    }
}